$(document).ready(function () {
  ...
  rangeSlider.noUiSlider.on("update", function (values, handle) {
    ...
    document.getElementsByName("salary").value = moneyFormat.from(values[0]);
    document.getElementsByName("salary1").value = moneyFormat.from(values[1]);
  });
});
